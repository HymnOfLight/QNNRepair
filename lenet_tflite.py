...
lr = 1e-1
num_classes = 10
model = InceptionV1ForCIFAR10(input_shape=(32, 32, 3), classes=num_classes, weight_decay=weight_decay)
...
with open('quantized_lenet_model.tflite', 'wb') as f:
    f.write(quantized_model)

quantized_model = tf.lite.Interpreter(model_path='quantized_lenet_model.tflite')
