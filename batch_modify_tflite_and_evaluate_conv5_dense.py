...
def find_tflite_files(folder_path):
    ...
    for root, dirs, files in os.walk(folder_path):
        for file in files:
            if "conv5_dense_corrected" in file and file.endswith(".tflite"):
                tflite_files.append(file)
    return tflite_files
directory = '/local-data/e91868xs/conv5/json'  
command_template = 'flatc -b --strict-json --defaults-json -o flatc_output tflite.fbs /local-data/e91868xs/conv5/json/'
...
with open('./conv5_dense_all_targets_neuron.txt', 'w') as tf_file:
