        ...
        if os.path.isfile(filepath) and filepath.endswith(".txt"):               
            ...
            if "47_weight_quant_tensor.txt" in filepath:
                ...
                if classifi_result != index:
                    ...
                    last_input_q = os.path.join(os.path.dirname(filepath), "46_weight_quant_tensor.txt")
                    last_input_f = os.path.join(os.path.dirname(filepath), folder_name + "_vggnet_43_tensor.txt")
                    last_output_q = os.path.join(os.path.dirname(filepath), "47_weight_quant_tensor.txt")
                    last_output_f = os.path.join(os.path.dirname(filepath), folder_name + "_vggnet_44_tensor.txt")
...
with open('vggnet_dense_1_importance_result.txt', 'w') as f1:
    print("dstar")
#     print(dstar)
#     print(np.argmax(dstar))
    ...
    f1.write("\n")
    np.savetxt('vggnet_dense_1_dstar.txt',dstar)
    print("jaccard")
#     print(jaccard)
#     print(np.argmax(jaccard))
    ...
    f1.write("\n")
    np.savetxt('vggnet_dense_1_jaccard.txt',jaccard)
    print("tarantula")
#     print(tarantula)
#     print(np.argmax(tarantula))
    ...
    f1.write("\n")
    np.savetxt('vggnet_dense_1_tarantula.txt',tarantula)
    print("ochiai")
#     print(ochiai)
#     print(np.argmax(ochiai))
    ...
    f1.write("\n")
    np.savetxt('vggnet_dense_1_ochiai.txt',ochiai)
    print("euclid")
#     print(euclid)
#     print(np.argmax(euclid))
    ...
    f1.write("\n")
    np.savetxt('vggnet_dense_1_euclid.txt',euclid)
    print("ample")
#     print(ample)
#     print(np.argmax(ample))
    ...
    f1.write("\n")
    np.savetxt('vggnet_dense_1_ample.txt',ample)
...
#     print(np.argmax(wong3))
    ...
    f1.write("\n")
    np.savetxt('vggnet_dense_1_wong3.txt',wong3)
