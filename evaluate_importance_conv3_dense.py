...
activate_diff_all_cnas = np.zeros(64)
activate_diff_all_cnaf = np.zeros(64)
activate_status_quant = np.zeros(64)
activate_status_float = np.zeros(64)
dstar = np.zeros(64)
tarantula = np.zeros(64)
jaccard = np.zeros(64)
ochiai = np.zeros(64)
ample = np.zeros(64)
euclid = np.zeros(64)
...
while stack:
    ...
    for filename in os.listdir(current_dir):
        ...
        if os.path.isfile(filepath) and filepath.endswith(".txt"):               
            ...
            if "17_weight_quant_tensor.txt" in filepath:
                ...
                if classifi_result != index:
                    ...
                    last_input_f = os.path.join(os.path.dirname(filepath), folder_name + "_conv3_4_flatten_tensor.txt")
                    last_output_q = os.path.join(os.path.dirname(filepath), "16_weight_quant_tensor.txt")
                    last_output_f = os.path.join(os.path.dirname(filepath), folder_name + "_conv3_5_dense_tensor.txt")
                    f_results = np.loadtxt(os.path.join(os.path.dirname(filepath), folder_name + "_conv3_6_dense_1_tensor.txt"), dtype=np.float32, delimiter='\n')
                    q_results = np.loadtxt(os.path.join(os.path.dirname(filepath), "17_weight_quant_tensor.txt"),dtype=np.float32, delimiter=',') 
...
with open('conv3_dense_importance_result.txt', 'w') as f1:
    print("dstar")
#     print(dstar)
#     print(np.argmax(dstar))
    ...
    f1.write("\n")
    np.savetxt('conv3_dense_dstar.txt',dstar)
    print("jaccard")
#     print(jaccard)
#     print(np.argmax(jaccard))
    ...
    f1.write("\n")
    np.savetxt('conv3_dense_jaccard.txt',jaccard)
    print("tarantula")
#     print(tarantula)
#     print(np.argmax(tarantula))
    ...
    f1.write("\n")
    np.savetxt('conv3_dense_tarantula.txt',tarantula)
    print("ochiai")
#     print(ochiai)
#     print(np.argmax(ochiai))
    ...
    f1.write("\n")
    np.savetxt('conv3_dense_ochiai.txt',ochiai)
    print("euclid")
#     print(euclid)
#     print(np.argmax(euclid))
    ...
    f1.write("\n")
    np.savetxt('conv3_dense_euclid.txt',euclid)
    print("ample")
#     print(ample)
#     print(np.argmax(ample))
    ...
    f1.write("\n")
    np.savetxt('conv3_dense_ample.txt',ample)
...
#     print(np.argmax(wong3))
    ...
    f1.write("\n")
    np.savetxt('conv3_dense_wong3.txt',wong3)
