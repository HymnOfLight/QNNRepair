...
with open('conv5_dense_importance_result.txt', 'w') as f1:
    print("dstar")
#     print(dstar)
#     print(np.argmax(dstar))
    ...
    f1.write("\n")
    np.savetxt('conv5_dense_dstar.txt',dstar)
    print("jaccard")
#     print(jaccard)
#     print(np.argmax(jaccard))
    ...
    f1.write("\n")
    np.savetxt('conv5_dense_jaccard.txt',jaccard)
    print("tarantula")
#     print(tarantula)
#     print(np.argmax(tarantula))
    ...
    f1.write("\n")
    np.savetxt('conv5_dense_tarantula.txt',tarantula)
    print("ochiai")
#     print(ochiai)
#     print(np.argmax(ochiai))
    ...
    f1.write("\n")
    np.savetxt('conv5_dense_ochiai.txt',ochiai)
    print("euclid")
#     print(euclid)
#     print(np.argmax(euclid))
    ...
    f1.write("\n")
    np.savetxt('conv5_dense_euclid.txt',euclid)
    print("ample")
#     print(ample)
#     print(np.argmax(ample))
    ...
    f1.write("\n")
    np.savetxt('conv5_dense_ample.txt',ample)
...
#     print(np.argmax(wong3))
    ...
    f1.write("\n")
    np.savetxt('conv5_dense_wong3.txt',wong3)
