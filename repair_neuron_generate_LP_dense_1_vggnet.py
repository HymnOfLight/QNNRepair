...
weight_file = "./models/vggnet/modelpredictionsMatMul.npy"
dense_weight = np.load(weight_file)
print(dense_weight.shape)
bias_file = "./models/vggnet/modelpredictionsBiasAddReadVariableOp.npy"
...
#     m.write('repair_dense_conv3_#' + str(neuron_index) + 'neuron.lp')
    ...
    if m.Status == GRB.OPTIMAL:
        ...
        with open('/local-data/e91868xs/resnet18_correction/vggnet_dense1_#' + str(neuron_index) + 'neuron_repair_result_with_all_pictures.txt', 'w') as f1:
